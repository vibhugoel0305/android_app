...
implements Filterable {
    ...
    public MyFavouriteAdapter(Context context, List<DummyContent.DummyItem> mValues, int x) {
    ...
    @NonNull
    @Override
    public MyFavouriteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                            int viewType) {
